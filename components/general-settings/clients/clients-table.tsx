...
const columns: TableColumn<Client>[] = [
  ...
  { accessorKey: 'CLBILL', header: 'Billing Code' },
  { accessorKey: 'CLEC1', header: 'Contact Email 1' },
  { accessorKey: 'CLEC2', header: 'Contact Email 2' },
  { accessorKey: 'CLEC3', header: 'Contact Email 3' },
  { accessorKey: 'CLEC4', header: 'Contact Email 4' },
  { accessorKey: 'CLEC5', header: 'Contact Email 5' },
  { accessorKey: 'CLEN1', header: 'Contact Name 1' },
  { accessorKey: 'CLEN2', header: 'Contact Name 2' },
  { accessorKey: 'CLEN3', header: 'Contact Name 3' },
  { accessorKey: 'CLEN4', header: 'Contact Name 4' },
  { accessorKey: 'CLEN5', header: 'Contact Name 5' },
